...
class TodayTaskCardWidget extends StatefulWidget {
  const TodayTaskCardWidget({
    super.key,
    required this.task,
    this.onTap,
    this.onEdit,
  ...
  @override
  State<TodayTaskCardWidget> createState() => _TodayTaskCardWidgetState();
}

class _TodayTaskCardWidgetState extends State<TodayTaskCardWidget> {
                  ...
                  if (!_isHovering) ...[
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        if (widget.isFirstTask &&
                            _focusModeService.isSessionActive) ...[
                          TaskTimerWidget(
                            task: widget.task,
                            isFirstTask: widget.isFirstTask,
                            showControls: false,
                          ),
                        ],
                      ],
